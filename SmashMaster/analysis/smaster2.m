...
b4 = (c1*c2*c3*c4*P1*R2*R3*RO + c1*c2*c3*c4*P1*P2*(R2 + R3)*RO)
b3 = (c1*c2*c4* P1* R2 *R3 + c1* c2 *c4* P1* P2* (R2 + R3) + c1* c2* c3 *P1 *P2* RO + c2* c3 *c4 *R2 *R3* RO + c1 *c3* c4* P1* (R2 + R3)* RO + c2* c3* c4* P2* (R2 + R3)* RO) 
b2 = (c1* c2* P1* P2 + c2* c4* R2* R3 + c1* c4* P1* (R2 + R3) + c2* c4* P2* (R2 + R3) + c1* c3* P1* RO + c2* c3* P2* RO + c3* c4* (R2 + R3)* RO)
b1 = (c1* P1 + c2* P2 + c4* (R2 + R3) + c3* RO);
b0 = 1;
...
a1 = (c3 *R1 + c1* (P1 + R1) + c3* R2 + c4* R2 + c2 *(P2 + R1 + R2) + c3* R3 + c4* R3 + c3* RO) 
a0 = 1
